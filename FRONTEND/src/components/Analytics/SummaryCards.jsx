...
const totalURLs = useSelector(
  (state) => state.urlStats?.data?.totalSummary?.total_urls
);

const totalClicks = useSelector(
  (state) => state.urlStats?.data?.totalSummary?.total_clicks
);

const avgClicks = useSelector(
  (state) => state.urlStats?.data?.totalSummary?.avg_clicks_per_url
);
